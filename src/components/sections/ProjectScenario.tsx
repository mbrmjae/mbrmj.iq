        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="w-full md:w-5/12 shrink-0 relative rounded-xl overflow-hidden shadow-2xl border border-white/5 group-hover:scale-105 transition-transform duration-500">
               <img src="/assets/PRD-Cover.png" alt="PRD Cover" className="w-full h-auto object-cover" />
            </div>
          </motion.div>
          ...
          >
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                <img src="/assets/Google_Drive_icon_(2020).svg" alt="Google Drive" className="w-8 h-8" />
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-4 p-3.5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                <img src="/assets/Google_Sheets_Logo_512px.png" alt="Google Sheets" className="w-7 h-7" />
              ...
              <div className="flex items-center gap-4 p-3.5 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                <img src="/assets/google-doc.png" alt="Google Docs" className="w-7 h-7" />
                <div className="flex flex-col">
